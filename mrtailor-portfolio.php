		...
		*/
		...
		public function gbt_portfolio_customizer( $wp_customize ) {
			...
			$wp_customize->add_section( 'portfolio', array(
		 		'title'       => esc_attr__( 'Portfolio', 'mrtailor-portfolio' ),
		 		'priority'    => 20,
		 	) );
			...
			$wp_customize->add_control( 
				new WP_Customize_Control(
					...
					array( 
						'type'			=> 'text',
						'label'       	=> esc_attr__( 'Portfolio Item Slug', 'mrtailor-portfolio' ),
						'description' 	=> __('<span class="dashicons dashicons-editor-help"></span>Default slug is "portfolio-item". Enter a custom one to overwrite it. <br/><b>You need to regenerate your permalinks if you modify this!</b>', 'mrtailor-portfolio'),
						'section'     	=> 'portfolio',
						'priority'    	=> 20,
					)
				)
...
if( $theme->template == 'mrtailor' && ( $theme->version >= '2.8.2' || ( !empty($parent_theme) && $parent_theme->version >= '2.8.2' ) ) ) {
